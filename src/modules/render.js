...
const renderDom = (function () {
  ...
  const project = (() => {
    function list() {
      ...
      projectArr.forEach((project, idx) => {
        ...
        const sidenavItemDelete = document.createElement("span");
        ...
        sidenavItemDelete.setAttribute("class", "sidenav__item-delete");

        sidenavItemContent.textContent = project.name;
        sidenavItemDelete.innerHTML =
        ...
        createProjectItemListener(sidenavItem,sidenavItemDelete);
      });
    }
  ...
  const todo = (() => {
    function list(_todosArr = null) {
      ...
      if(_todosArr === null){
        _todosArr = todoController.getTodosList();
      }
